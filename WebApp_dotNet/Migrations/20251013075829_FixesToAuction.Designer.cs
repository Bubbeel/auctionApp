...
namespace WebApp_dotNet.Migrations
{
    ...
    [Migration("20251013075829_FixesToAuction")]
    partial class FixesToAuction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApp_dotNet.Persistence.AuctionDb", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTime(2025, 10, 13, 9, 58, 29, 135, DateTimeKind.Local).AddTicks(8367),
                            CurrentPrice = 300,
            ...
            modelBuilder.Entity("WebApp_dotNet.Persistence.BidDb", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            AuctionId = -1,
                            DateAdded = new DateTime(2025, 10, 13, 9, 58, 29, 135, DateTimeKind.Local).AddTicks(8603),
                            Username = "Bob@kth.se"
                        });
                });
